			...
			<div class="panel panel-default">
				...
				<div class="panel-body">					
					<div class="table-container">
						<form method="POST" action="{{ route('transfer.cancel', $transfer->id) }}"  role="form">
							{{ csrf_field() }}
							...
							<div class="row">
								...
								<input type="hidden" name="id" id="id" class="form-control input-sm" value="{{ $transfer->id }}">
								<div class="col-xs-12">
									<div class="form-group">
										<label class="col-md-6">Nombre:</label>
										<input type="text" name="name" id="name" class="form-control input-sm" value="{{ $transfer->name }}" disabled="disabled">
									</div>
								</div>
								<div class="col-xs-12">
									<div class="form-group">
										<label class="col-md-6">Email:</label>
										<input type="email" name="email" id="email" class="form-control input-sm" value="{{ $transfer->email }}" disabled="disabled">
									</div>
								</div>
								<div class="col-xs-12">
									<div class="form-group">
										<label class="col-md-6">Fecha:</label>
										<input type="date" name="date" class="form-control input-sm" value="{{ $transfer->date_pick }}" min="{{ $transfer->date_pick }}" disabled="disabled">
									</div>
								</div>
								<div class="col-xs-12">
									<div class="form-group">
										<label class="col-md-6">Hora:</label>
										<input type="time" name="time" class="form-control input-sm" value="{{ $transfer->time_pick }}" disabled="disabled">
									</div>
								</div>
								<div class="col-xs-12">
									<div class="form-group">
								...
								<div class="col-xs-12">
									<div class="form-group">
										...
										<input type="text" name="price" class="form-control input-sm" value="{{ $transfer->precio->precio }}" disabled="disabled">
									</div>
								</div>
								<div class="col-xs-12">
									<div class="form-group">
										<label class="col-md-6">Cantidad de pasajeros:</label>
										<input type="text" name="passenger" class="form-control input-sm" value="{{ $transfer->passengers }}" disabled="disabled">
									</div>
								</div>
								<div class="col-xs-12">
									<div class="form-group">
										<label class="col-md-6">Cantidad de maletas:</label>
										<input type="text" name="suitcase" class="form-control input-sm" value="{{ $transfer->suitcase }}" disabled="disabled">
									</div>
								</div>
							</div>
							<div class="row">
								<div class="col-xs-12">
									...
									@else
										{{-- <a href="{{ action('TransferController@cancel', $transfer->id) }}" class="btn btn-danger" >Cancelar Transfer</a> --}}
										@if($status->statetf_id != 4)
											<button class="btn btn-danger" type="submit">Cancelar Servicio</button>
										@endif
										<a href="{{ action('TransferController@indexu', Auth::user()->id) }}" class="btn btn-info" >Atrás</a>
									@endif
								</div>	
							</div>
						</form>
